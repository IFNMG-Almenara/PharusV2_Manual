...
![Convidar Avaliador](../../../../images/convidarAvaliador.png)
...
4. Selecione [ 1 ] **"AVALIAÇÃO"** para acessar as opções de gerenciamento dos avaliadores.
5. Clique em [ 2 ]**"AVALIADORES"** para visualizar a lista de avaliadores do evento.
