...
No sistema do Pharus é possível o organizador preencher diversos campos que serão cruciais para que os usuários visualizem seu evento e consigam ter acesso à maior quantidade de informações sobre ele, antes de sua inscrição.
